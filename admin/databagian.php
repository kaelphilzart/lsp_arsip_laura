          ...
          <div class="">
            <div class="page-title">
              <div class="title_right">
                <h2>Bagian > <small>Data Account Bagian</small></h2>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data ><small>Account Bagian</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <a href="inputbagian.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Account Bagian</button></a>
                  <div class="x_content">
                  <div class="x_content">
                             <?php
                              ...
                              if ($total == 0) {
                                echo"<center><h2>Belum Ada Data Account Bagian</h2></center>";
                              }
                              else{?>
