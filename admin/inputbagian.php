                    ...
                    <form action="proses/proses_inputbagian.php"  name="formbagian" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="nama_bagian" name="nama_bagian" required="required" class="form-control col-md-7 col-xs-12">
                            <option disabled selected>-- Pilih Bagian --</option>

                            <!-- ambil data untuk data bagian -->
                                <?php 
                                include("../koneksi/koneksi.php");

                                  $sql=mysqli_query($db,"SELECT * FROM tb_bidang order by id asc");
                                  while ($data=mysqli_fetch_array($sql)) {
                                ?>
                               <option value="<?=$data['jenis_bidang']?>"><?=$data['jenis_bidang']?></option> 
                              <?php
                                }
                             ?>
                          </select>
