            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-file-text"></i> Data Bagian<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="data_bidang.php"><i class="fa fa-inbox"></i>Bagian</a></li>
                      <li><a href="databagian.php"><i class="fa fa-inbox"></i> Account Bagian</a></li>
                    </ul>                             
                  </li>                
                </ul>
              </div>
