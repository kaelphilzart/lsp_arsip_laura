...
<head>
    <meta charset="UTF-8">
    <title>Form Disposisi Surat</title>
</head>
<body>
    <h2>Form Disposisi Surat</h2>
    <form action="downloaddisposisi.php" method="post">
        ...
        <input type="text" name="tujuan_disposisi" required><br>

        <label for="catatan">Catatan:</label>
        <textarea name="catatan" rows="4" required></textarea><br>

        <input type="submit" value="Kirim Disposisi">
    </form>
</body>
</html>
<?php
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Lakukan apa pun yang perlu dilakukan dengan data disposisi, seperti menyimpan ke database.
