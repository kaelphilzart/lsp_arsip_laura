                  ...
                  <div class="x_content">
                    ...
                    <form  action="proses/proses_editprofile.php" method="post" enctype="multipart/form-data" name="formeditprofile" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="password" id="password_bagian" name="password_bagian" required="required" maxlength="50" placeholder="Masukkan Password Bagian" class="form-control col-md-7 col-xs-12" value="<?php echo $data['password_bagian'];?>">
                        </div>
                      </div>
                      <div class="form-group">
