...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Kebudayaan dan Pariwisata Kota Blitar </title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="proses/proses_surat.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <option disabled selected value="<?php echo $data['disposisi1'];?>"><?php echo $data['disposisi1'];?></option>
                                <?php include '../koneksi/koneksi.php';
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="datasuratmasukkepala.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Batal</a>
