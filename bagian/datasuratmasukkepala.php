                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            ...
                            while($data = mysqli_fetch_array($query1)){
                              ...
                              <a href=edit_surat_masuk_kepala.php?id_suratmasuk='.$data['id_suratmasuk'].'><button type="button" title="Edit" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></button></a>
                              <a href= "proses/proses_pdf.php?id_suratmasuk='.$data['id_suratmasuk'].'" target="_blank"><button type="button" title="Unduh Disposisi" class="btn btn-info btn-xs"><i class="fa fa-file-text"></i></button></a>
                              </tr>';
                            }
                            ?>
                      </tbody>
