...
<html lang="en">
  <head>
    ...
    <title>Arsip Surat Dinas Kebudayaandan Pariwisata Kota Blitar
    </title>
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="proses_login.php" id="login" name="login" method="post">
              ...
              <div class="separator">
                <div>
                  <h2><i class="fa fa-institution"></i> Dinas Kebudayaan dan Pariwisata Kota Blitar</h2>
                </div>
              </div>
            </form>
          </section>
