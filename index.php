      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Desa Karangduren, Kecamatan Pakisaji </p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              ...
              <h3 class="pad-bt15">Surat Bagian</h3>
            </div>
          </div>
